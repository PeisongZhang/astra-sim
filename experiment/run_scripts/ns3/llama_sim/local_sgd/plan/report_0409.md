...
![Dual Spine Switch Topology](dual_spine_topology_fixed.svg)
...
![OCS Physical Topology](ocs_physical_topology.svg)
...
![OCS Full Mesh Topology](ocs_fullmesh_topology.svg)
...
![OCS Ring Topology](ocs_ring_topology.svg)
...
![Direct Fiber Full Mesh Topology](direct_fiber_topology.svg)
...
![Dual OCS Physical Topology](dual_ocs_physical_topology.svg)
...
![Dual OCS Logical Topology](dual_ocs_logical_topology.svg)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **(In-DC)** | Intra-Node DP + Inter-Node PP | 6,836,551,111 | 960,000,019 | 1.0000x | 14.04% |
| **(Inter-DC) Spine Switch * 1** | Intra-DC DP + Inter-DC PP | 6,847,276,711 | 970,725,619 | 1.0016x | 14.18% |
| **(Inter-DC) Spine Switch * 2** | Intra-DC DP + Inter-DC PP | 6,850,314,961 | 973,763,869 | 1.0020x | 14.21% |
| **(Inter-DC) OCS-Fullmesh** | Intra-DC DP + Inter-DC PP | 6,879,819,219 | 1,003,268,127 | 1.0063x | 14.58% |
| **(Inter-DC) OCS-Ring** | Intra-DC DP + Inter-DC PP | 6,863,615,357 | 987,064,265 | 1.0040x | 14.38% |
| **(Inter-DC) Direct Fiber-Fullmesh** | Intra-DC DP + Inter-DC PP | 6,877,147,219 | 1,000,596,127 | 1.0059x | 14.55% |
| **(Inter-DC) Dual OCS-Fullmesh** | Intra-DC DP + Inter-DC PP | 6,886,144,012 | 1,009,592,920 | 1.0073x | 14.66% |
