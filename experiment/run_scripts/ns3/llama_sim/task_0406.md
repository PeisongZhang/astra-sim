...
![4 DC Cross-Datacenter Topology](dc_spine_topology.svg)


### 2.3 跨DC多个电Switch (Spine Switch)
- DC内部的网络配置和2.1, 2.2相同
- 跨DC通过2个Spine Switch完成互联，组成Clos拓扑，链路带宽都是600Gbps
- 数据中心配置：
  - DC 0: 上海临港数据中心
  - DC 1: 苏州常熟数据中心
  - DC 2: 杭州滨江数据中心  
...
- Ring连接顺序: LBW Switch 0 ↔ 1 ↔ 2 ↔ 3 ↔ 0 (顺时针方向)
  - Switch 0 (上海临港) ↔ Switch 1 (苏州常熟): 1.063ms, 600Gbps
  - Switch 1 (苏州常熟) ↔ Switch 2 (杭州滨江): 0.903ms, 600Gbps  
  - Switch 2 (杭州滨江) ↔ Switch 3 (宁波杭州湾): 0.719ms, 600Gbps
  - Switch 3 (宁波杭州湾) ↔ Switch 0 (上海临港): 0.879ms, 600Gbps
...
- 各LBW Switch之间的直连链路参数（基于DC之间的直接时延）：
  ...
  - 注：各链路带宽均为400Gbps
- 链路带宽都是400Gbps（与2.4.2 OCS Full mesh保持一致）
