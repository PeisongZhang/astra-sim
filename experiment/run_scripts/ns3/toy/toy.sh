...
WORKLOAD_DIR="/workspaces/dev_test/tutorials/micro2024/chakra-demo/demo3/toy_model"
WORKLOAD="${WORKLOAD_DIR}/toymodel"
COMM_GROUP_CONFIGURATION="${WORKLOAD_DIR}/toymodel.json"
