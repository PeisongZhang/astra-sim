...
# --- Configuration files ---
WORKLOAD_DIR_DEFAULT="${PROJECT_DIR}/../dnn_workload/megatron_gpt_76b/attfused_sgdstandard_layer60_iter1_batch1792_micro2_seq2048_dp32_tp8_pp4_sp1_ep1_ar0"
...
"${ASTRA_SIM:?}" \
    ...
    --logging-folder="${SCRIPT_DIR}/log_analytical_noar"
