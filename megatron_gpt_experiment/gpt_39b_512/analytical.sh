...
# --- Configuration files ---
WORKLOAD_DIR_DEFAULT="${PROJECT_DIR}/../dnn_workload/megatron_gpt_39b/attfused_sgdstandard_layer48_iter1_batch1536_micro2_seq2048_dp32_tp8_pp2_sp1_ep1_ar1"
...
# Parallel event processing speeds up analytical sim for TP-heavy workloads.
