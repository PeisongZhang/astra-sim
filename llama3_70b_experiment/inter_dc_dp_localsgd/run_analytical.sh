...
# W-lsgd: ITERATION=2, LocalSGD interval=2, Llama3-70B, DP=32 TP=8 PP=4.
WORKLOAD_DIR_DEFAULT="${PROJECT_DIR}/../dnn_workload/llama3_70b/fused_localsgd_80_2_512_2_2048_1f1b_v1_sgo1_ar1"
...
echo "[ASTRA-sim] E4 Llama3-70B inter-DC DP + LocalSGD (1024 GPUs, ITERATION=2 interval=2)..."
